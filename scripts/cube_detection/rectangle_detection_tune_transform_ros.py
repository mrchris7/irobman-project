...
#depth_image = img_depth.get_data()
...
def transform(points_2d, current_pose=None):
    ...
    for point_2d in points_2d:
        ...
        point_camera = np.array([x_3d, y_3d, z_3d, 1])
...
cv2.createTrackbar('area_min', window_name, 909, 10000, change_area_min)
cv2.createTrackbar('area_max', window_name, 8578, 10000, change_area_max)
